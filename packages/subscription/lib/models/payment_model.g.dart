...
PaymentModel _$PaymentModelFromJson(Map<String, dynamic> json) => PaymentModel(
  ...
  spotCountSnapshot: (json['spotCountSnapshot'] as num).toInt(),
  pricePerSpotSnapshot: (json['pricePerSpotSnapshot'] as num?)?.toInt(),
...
Map<String, dynamic> _$PaymentModelToJson(PaymentModel instance) => <String, dynamic>{
  ...
  'spotCountSnapshot': instance.spotCountSnapshot,
  'pricePerSpotSnapshot': instance.pricePerSpotSnapshot,
