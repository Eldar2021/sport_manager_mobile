...
class OccupiedTableFooter extends StatelessWidget {
  const OccupiedTableFooter({
          ...
          child: Column(
            ...
            children: [
              FilledButton.icon(
                ...
                label: Text(isPaused ? context.l10n.tableDetailResume : context.l10n.tableDetailPause),
              ),
