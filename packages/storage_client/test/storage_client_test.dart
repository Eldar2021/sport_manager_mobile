  ...
  group('SecureStorage', () {
    ...
    group('Read', () {
      test('return String `mockValue` succesfully', () {
        ...
        final actual = preferencesStorage.readString(mockKey);
      ...
      test('return bool `mockBoolValue` succesfully', () {
        ...
        final actual = preferencesStorage.readBool(mockKey);
      ...
      test('return double `mockDoubleValue` succesfully', () {
        ...
        final actual = preferencesStorage.readDouble(mockKey);
      ...
      test('return int `mockIntValue` succesfully', () {
        ...
        final actual = preferencesStorage.readInt(mockKey);
      ...
      test('return List<String> `mockListStringValue` succesfully', () {
        ...
        final actual = preferencesStorage.readStringList(mockKey);
      ...
      test('throw `StorageException` fails', () async {
        ...
        expect(
          () => preferencesStorage.readString(mockKey),
    ...
    group('Write', () {
      test('write String succesfully', () async {
        ...
        expect(
          preferencesStorage.writeString(
            key: mockKey,
            value: mockValue,
          ),
          completes,
    ...
    group('Delete', () {
      ...
      test('throw `StorageException` fails', () async {
        ...
        expect(
          () async => preferencesStorage.delete(mockKey),
          throwsA(isA<StorageException>()),
        );
      });
    });
